...
One document per independently buildable feature. Parts that cannot be built without each
other live together in a single document (e.g. the full-card scanning chain); a document may
depend on *shipped* features but never on another proposal.

| Document | Status |
|----------|--------|
| [Turn tracking and next-turn reminders](turn-tracking-and-reminders.md) | Shipped 2026-08-05 |
